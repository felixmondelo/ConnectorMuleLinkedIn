package org.mule.modules.connectormulelinkedin;
...
import org.mule.modules.connectormulelinkedin.config.ConnectorConfig;

@Connector(name="connector-mule-linked-in", friendlyName="ConnectorMuleLinkedIn")
public abstract class ConnectorMuleLinkedInConnector {
